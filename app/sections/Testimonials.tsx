            ...
            <div className="grid gap-6 text-center md:grid-cols-3">
                ...
                <div
                    ...
                    <p className="mt-4">
                        ...
                        Zetone covers all the bases that you need to land a job in a MNC. Their full stack development course is especially useful as you don't get to learn those skills at
                                that level in your college courses. It's a great resume point which really helped me during the tech interviews. They also give individual attention to each student and make sure every student is making progress.
                    </p>
                    </div>
                </div>
                </div>
