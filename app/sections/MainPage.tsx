            ...
            <div className="w-[80%] h-[80%] mx-auto flex justify-center items-center">
                <div className="grid mt-40">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mx-auto">
                        <motion.div className="order-last md:order-first flex items-center font-medium"
                            initial="hide"
                            whileInView="show"
                        ...
                        >
                            <div className="z-10 duration-100 text-2xl md:text-6xl">We give <span className="text-[#4287f5]">you</span> the tools to carve your path to <span className="text-[#4287f5]">Success</span>
                                <div className="pt-20 text-base md:text-3xl text-gray-600">Upskill yourself with industry specific courses employers are looking for in a candidate</div>
                            </div>
                        </motion.div>
