    ...
    return(
        <div className="w-full">
            <div className="w-full h-full mx-auto  grid items-center text-center">
                ...
                <p className="px-20">Book Your <span className=" text-red-700 font-bold">Free</span> slot now to levrage zetone expertise to understand where you stand. Get </p>
            </div>
                <div className="grid pt-20 mx-5"
                    // initial="hide"
                    // whileInView="show"
                    ...
                    {/* card-1 */}
                        ...
                        <div className="flex items-center hover:scale-105 ease-in duration-300">
                            <div className="rounded-xl border-red/50 border-2">
                                <div className="p-8">
                                    <div className="">
                                        <h4 className="mb-4 text-xl md:text-2xl font-semibold">Mock Interview</h4>
                                    </div>
                                    <div className="flex justify-center">
                                        <Image src="/interview.svg" alt="" width={100} height={100}/>
                                    </div>
                                    <div className="text-lg md:text-xl mt-4"><p>Ace Your next Interview with Expert-Led Mock Interviews!</p></div>
                                    <div className="pt-10">
                                        
                                        <BasicButton title="Learn More" clickAction={clickAction} />
                                    </div>
                                </div>
                            </div>
                        </div>
                    {/* card2 */}
                        <div className="flex items-center hover:scale-105 ease-in duration-300">
                            <div className="rounded-xl border-red/50 border-2">
                                <div className="p-8">
                                    <div className="">
                                        <h4 className="text-cenetr mb-4 text-xl md:text-2xl font-semibold">Get Referral</h4>
                                    </div>
                                    <div className="flex justify-center">
                                        <Image className="" src="/refrall.svg" alt="" width={100} height={100}/>
                                    </div>
                                    <div className="text-lg md:text-xl mt-4"><p>Pinpoint target companies, and access relevant job referrals through guided discussions.</p></div>
                                    <div className="pt-10">
                    ...
                    {/* card3 */}
                        <div className="flex items-center hover:scale-105 ease-in duration-300">
                                <div className="rounded-xl border-red/50 border-2 ">
                                    ...
                                    <div className="p-8">
                                        <div className="">
                                            <h4 className="mb-4 text-xl md:text-2xl font-semibold">Resume Review</h4>
                                        </div>
                                        <div className="flex justify-center">
                                            <Image src="/interview.svg" alt="" width={100} height={100}/>
                                        </div>
                                        <div className="text-lg md:text-xl mt-4"><p>Elevate your chances have your IT resume professionally reviewed.</p></div>
                                        <div className="pt-10">
                                            <BasicButton title="Learn More" />
                                        </div>
                                    </div>
