    ...
    <div className="w-full my-20 mt-40">
      <div className="w-full h-full mx-auto  grid ">
        <div className="px-8 font-semibod flex justify-center">
          <div>
            <p className="text-2xl font-semibold md:text-4xl uppercase ">
              Courses
            </p>
            <hr className="" />
          </div>
                ...
                <div className="p-8">
                  <div className="flex justify-center">
                    <h4 className="mb-4 text-2xl font-semibold">
                      Pay-After-Placement End-to-End Course
                    </h4>
                  </div>
                  <div className="flex justify-center">
                  ...
                  <div>
                    <ul className="space-y-4  list-disc list-inside dark:text-gray-400">
                      <ol className="pl-5 mt-2 space-y-1 list-decimal list-inside">
                        <li>
                          Working professionals, pre-final/final year
                          engineering students.
                        </li>
                        <li> Crafted by IIT Alumni Industry experts.</li>
                        <li>
                          {" "}
                          Pay as low as 10% of your first-year base salary upon
                          placement.
                        </li>
                        <li> Engage in a 6-month weekend batch.</li>
                        <li>
                          {" "}
                          Benefit from a limited class size of under 7 students.
                        </li>
                      </ol>
                    </ul>
                  </div>
                  ...
                  <div>
                    <ul className="space-y-4  list-disc list-inside dark:text-gray-400">
                      <ol className="pl-5 mt-2 space-y-1 list-decimal list-inside">
                        ...
                        <li>
                          {" "}
                          In-depth learning: Advanced DSA, system design,
                          interview prep, resume building, referrals.
                        </li>
                        <li> Crafted by IIT Alumni Industry experts.</li>
                        <li> 6-month weekend batch less than 20 students</li>
                        <li>
                          Enjoy one-on-one mentorship for personalized guidance
                        </li>
                      </ol>
                    </ul>
                  </div>
                  ...
                  <div>
                    <ul className="space-y-4  list-disc list-inside dark:text-gray-400">
                      <ol className="pl-5 mt-2 space-y-1 list-decimal list-inside">
                        ...
                        <li>
                          {" "}
                          Focus: Advanced DSA, system design, interview prep,
                          resume crafting, referrals
                        </li>
                        <li>
                          {" "}
                          1.5-month weekend batch (less than 20 students)
                        </li>
                  ...
                  <div>
                    <ul className="space-y-4  list-disc list-inside dark:text-gray-400">
                      <ol className="pl-5 mt-2 space-y-1 list-decimal list-inside">
                        ...
                        <li>
                          {" "}
                          Tailored mentorship: placements, DSA (Basic &
                          Advanced), system design, interview prep, resume
                          building, referrals.
                        </li>
                      </ol>
                    </ul>
