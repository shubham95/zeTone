            ...
            <div className="w-full h-full mx-auto pt-[25%] md:pt-[10%]">
                <div className="text-center">
                    ...
                    <div className="pt-10">
                        ...
                        <GradientButton title="Schedule Interview" clickAction={toggleShowModal}  />
                    </div>
                    <InterviewModalForm openModal={openModal} toggleShowModal={toggleShowModal}/>
                    ...
                    <div className="mx-8 pt-10 flex justify-center items-center">
                        <div className="">
                            <div className="flex -space-x-4">
                                <Image className="border-2 border-white rounded-full dark:border-gray-800" src="/profile-picture-1.jpg" alt="1" width={30} height={30}></Image>
                                <Image className="border-2 border-white rounded-full dark:border-gray-800" src="/profile-picture-2.jpg" alt="1" width={30} height={30}></Image>
                                <Image className="border-2 border-white rounded-full dark:border-gray-800" src="/profile-picture-3.jpg" alt="1" width={30} height={30}></Image>
                                <Image className="border-2 border-white rounded-full dark:border-gray-800" src="/profile-picture-4.jpg" alt="1" width={30} height={30}></Image>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 mx-[20%]">
                    <div className="grid md:grid-cols-2 mt-20 px-30  items-center justify-center">
                        <div className="">    
                            <div className="flex justify-center md:justify-start">
                                <Image className="" src="/interview.svg" width={150} height={150} alt="/"/>
                            </div>
                            ...
                            <div className="text-sm md:text-lg md:w-[80%] flex justify-center md:justify-start p-5 md:p-0">
                                <p>Practice coding, system design, and behavioral interviews with Industry Experts</p>
                            </div>
                        </div>
                        <div className="">
                    ...
                    <div className="grid md:grid-cols-2 mt-20 px-30  items-center justify-center">
                        ...
                        <div className="">
                            ...
                            <div className="text-sm md:text-lg md:w-[80%] flex justify-center md:justify-start p-5 md:p-0">
                                <p className="">Find the best places to spend your time with on-point feedback and suggestions.</p>
                            </div>
                        </div> 
